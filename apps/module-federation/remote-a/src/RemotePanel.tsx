        ...
        <View style={styles.panel}>
            <View style={styles.panelHeading}>
                ...
                <View>
                    ...
                    <Text style={styles.panelMeta}>Prefix rma / yellow (#facc15) / port 8082</Text>
                </View>
            </View>
            ...
            <Signal
                ...
                testID="remote-a-host-shared"
            />
            <Signal
                className="rma:mf-remote-a-only"
                label="rma:mf-remote-a-only: #facc15"
                testID="remote-a-only"
            />
            <Signal
                className="rma:mf-conflict"
                label="rma:mf-conflict: #facc15"
                testID="remote-a-conflict"
            />
            <Signal
                className="rma:bg-mf-shared"
                label="--rma-color-mf-shared: #facc15"
