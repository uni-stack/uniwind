    ...
    return (
        <ScrollView contentContainerStyle={styles.page}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Three bundles, stable styles</Text>
                <Text style={styles.intro}>
                    The host owns global CSS. Each remote contributes a prefixed delta on web and an owner-keyed merge on native. Load both orders;
                    every signal must keep its declared color.
                </Text>
            </View>
            ...
            <View style={styles.panel}>
                <View style={styles.panelHeading}>
                    ...
                    <View>
                        ...
                        <Text style={styles.panelMeta}>Owns global.css and declares green (#16a34a)</Text>
                    </View>
                </View>
                <Signal
                ...
                <Signal
                    ...
                    label="Host semantic class mf-conflict: #16a34a"
                    testID="host-conflict"
                />
                <Signal
                    className="bg-mf-shared"
                    label="Host variable --color-mf-shared: #16a34a"
