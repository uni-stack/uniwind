        ...
        <ScrollView className="flex-1 bg-gray-100 py-safe-or-10">
            ...
            <View className="px-4">
                ...
                <View className="bg-white p-4 rounded-lg mb-4">
                    ...
                    <Text className="not-italic mb-2">
                        not-italic: Not italic text style
                    </Text>
                    <Text className="underline mb-2">underline: Underlined text</Text>
                    <Text className="line-through mb-2">
                        line-through: Line through text
                    </Text>
                    <Text className="no-underline mb-2">
                        no-underline: No underline text
                    </Text>
                </View>
                ...
                <View className="bg-white p-4 rounded-lg mb-4">
                    ...
                    <Text className="normal-case mb-2">
                ...
                <View className="bg-white p-4 rounded-lg mb-4">
                    ...
                    <View className="shadow-xl bg-white border border-gray-200 p-4 rounded-lg mb-4">
                        <Text className="text-gray-800">
                            Card with shadow-xl and border
                        </Text>
